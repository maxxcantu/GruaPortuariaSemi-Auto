...
% num_carriles_Barco = 10; %Carril 1=SB, 9 carriles efectivos
% 
% contRand = [10 17 20 22 20 17 14 8 5 18];
% %contRand = randi([1 20],1,num_carriles_Barco);
% 
% x_carril_muelle = [-30,-25,-20,-15,-10,-5];
% x_carril_barco  = zeros(1,num_carriles_Barco);
% y_carril_barcoPar  = zeros(1,num_carriles_Barco);
% 
% for i=1:num_carriles_Barco
%      x_carril_barco(i) = 55/(num_carriles_Barco+1)*i-5;
%      y_carril_barcoPar(i) = contRand(i)*H_c -20;
% end
% y_carril_barcoPar(1) = 15; %Coordenada y de SB
% 
% offset_xCarrilMuelle = 35; %Usado en mod fisico, para calcular x_t inicial (x_t_0)
